...
package org.laptop.linuxlaptop.api;

import org.laptop.linuxlaptop.api.dto.DeviceJSON;
import org.laptop.linuxlaptop.api.dto.SensorRecord;
import org.laptop.linuxlaptop.api.util.APIUtil;
import org.laptop.linuxlaptop.api.util.ZipUtil;
import org.laptop.linuxlaptop.api.util.ZipArchive;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "linuxlaptop"));
            APIUtil.getDeviceManagementService().addOperation("linuxlaptop", commandOp,
                                                              deviceIdentifiers);
