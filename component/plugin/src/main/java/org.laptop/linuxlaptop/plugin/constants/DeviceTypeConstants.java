...
package org.laptop.linuxlaptop.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "linuxlaptop";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "linuxlaptop_DEVICE_ID";
...
//    public static final String SENSOR_TYPE3_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_cpuusagesensor";
    ...
    public static final String DATA_SOURCE_NAME = "jdbc/linuxlaptopDM_DB";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/linuxlaptop/+/batterylevelsensor";
