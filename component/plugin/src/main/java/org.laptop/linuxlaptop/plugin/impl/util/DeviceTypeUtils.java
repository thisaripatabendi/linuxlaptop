...
package org.laptop.linuxlaptop.plugin.impl.util;
...
/**
 * Contains utility methods used by linuxlaptop plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.laptop.linuxlaptop.plugin.impl.util.DeviceTypeUtils.class);
